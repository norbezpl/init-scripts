...
apt update
apt upgrade -y
apt install -y net-tools htop ssh gdebi mc libgee-0.8-dev libjson-glib-dev libvte-2.91-dev valac aria2 lsb-release aptitude yarn nginx wget silversearcher-ag guake git curl nano apt-transport-https ca-certificates gnupg-agent software-properties-common
